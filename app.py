...
# BIS PUBLIC VIEW
    ...
    # Overlay-Logik bleibt, wie du sie hast
    ...
    # Kapselung zur Vermeidung von Geisterzeilen
    ...
    with main_placeholder:
        ...
        if df_full is not None:
            ...
            if style_rules: st.markdown(f"<style>{style_rules}</style>", unsafe_allow_html=True)
